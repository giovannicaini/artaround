// Snapshot di database + cartella uploads, per poter "provare e poi
// rimettere tutto a posto" (sezione Backup, solo admin). Niente
// mongodump/mongorestore: non sono installabili su questa macchina (nessun
// accesso root), quindi il dump passa dal driver Mongo stesso (EJSON
