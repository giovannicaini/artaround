...
export class UiIcon extends LitElement {
  ...
  render() {
    ...
    return html`
      <svg class="${this.sizeClasses} flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
        <path d="${path}"/>
      </svg>
    `;
  }
