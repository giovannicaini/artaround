  ...
  render() {
    return html`
      <div class="space-y-1.5">
        ...
        ${this.value ? html`
          <!-- Image Preview -->
          <div class="relative rounded-lg overflow-hidden border border-surface-200 dark:border-surface-700 bg-surface-50 dark:bg-surface-800">
            <img 
              src="${this.value}" 
              alt="Preview" 
        ...
        ` : html`
          ...
          >
            ...
            <div class="text-center">
              ${this.uploading ? html`
                <svg class="animate-spin h-10 w-10 text-brand-500 mx-auto mb-3" fill="none" viewBox="0 0 24 24">
                  <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                  <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z"></path>
                </svg>
                <p class="text-sm text-surface-600 dark:text-surface-400">Elaborazione in corso...</p>
              ` : html`
                <ui-icon name="upload" size="lg" class="text-surface-400 dark:text-surface-500 mx-auto mb-3"></ui-icon>
        ...
        ${this.error ? html`
          <p class="text-xs text-danger-600 dark:text-danger-400 flex items-center gap-1" role="alert">
